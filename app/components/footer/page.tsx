...
export default function Footer() {
  ...
  return (
    <footer
      ref={footerRef}
      className="relative bg-[#3d3d3b] text-[#c5c5c1] pt-20 pb-10 overflow-hidden"
    >
      ...
      <div className="footer-content max-w-6xl mx-auto px-6 relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-end border-b border-white/10 pb-16">
          {/* LEFT: PROPERTY STAMP */}
          <div className="space-y-4">
            <div className="inline-block border-2 border-[#c5c5c1]/30 p-4 -rotate-3">
              <p className="font-mono text-[10px] uppercase tracking-widest opacity-50 mb-1">
                Property of:
              </p>
              <h3 className="font-sketch text-3xl text-white">Vishal Tanwar</h3>
          ...
          <div className="flex justify-center gap-6">
            {[
              ...
              <a
                key={i}
                href={social.href}
                className={`group relative p-4 ${social.bg} border border-white/10 transition-all hover:-translate-y-2`}
          ...
          <div className="flex flex-col items-end gap-4">
            <button
              onClick={scrollToTop}
              className="group flex items-center gap-3 font-sketch text-xl hover:text-white transition-colors"
            >
        ...
        {/* BOTTOM BAR */}
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-4 opacity-30 font-mono text-[10px] uppercase tracking-[0.2em]">
